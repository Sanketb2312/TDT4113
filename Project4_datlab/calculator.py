...
class Calculator:
    ...
    def convert_to_RPN(self, input_queue):
        '''Method for convertibf fron queue to RPN'''
    ...
    def calculate_expression(self, text):
        '''Methdo for calculating value from string'''
...
if __name__ == '__main__':
    ...
    # .execute(calc.operators['ADD'].execute(1,calc.operators['MULTIPLY'].execute(2,3))))
    #print("\n")
